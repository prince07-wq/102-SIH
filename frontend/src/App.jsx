  ...
  return (
    <aside className={`sidebar ${open ? "sidebar--open" : ""}`}>
      ...
      <nav className="sidebar__nav" aria-label="Primary">
        {NAV_ITEMS.map((item) => {
          ...
          return item.path ? (
            ...
            <span
              key={item.key}
              className="sidebar__link sidebar__link--inactive"
              aria-disabled="true"
            >
              {content}
            </span>
      ...
      <div className="sidebar__mission">
        <p>
          <strong>Our mission:</strong> Detect anomalies. Prioritize
          investigation. Drive transparency.
        </p>
  ...
  return (
    <header className="app-header">
      ...
      <div className="app-header__search" ref={searchContainerRef}>
        ...
        {resultsOpen &&
          searchInput &&
          (isDebouncing || searchMeta.loading || searchMeta.count !== null) && (
            <div className="app-header__search-results">
              {isDebouncing || searchMeta.loading ? (
                ...
                <>
                  <span className="app-header__search-status">
                    {searchMeta.count ?? 0} results
                  </span>
                  {searchMeta.results.map((project) => (
                    <button
                      key={project.projectId}
                      type="button"
                      onClick={() => selectSearchResult(project.projectId)}
                    >
                      <strong>{project.workName}</strong>
                      <span>
                        {project.projectId} · {project.state} · {project.mpName}
                      </span>
                    </button>
                  ))}
                </>
...
function IconShield() {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path
        d="M10 2 3.5 4.4v4.9c0 4.2 2.8 7.6 6.5 8.7 3.7-1.1 6.5-4.5 6.5-8.7V4.4L10 2Z"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
      <path
        d="M7.2 10.1l2 2 3.6-4"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function IconFolder() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M2.5 5.2c0-.7.6-1.3 1.3-1.3h3.1l1.4 1.6h6a1.3 1.3 0 0 1 1.3 1.3v6a1.3 1.3 0 0 1-1.3 1.3H3.8a1.3 1.3 0 0 1-1.3-1.3V5.2Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
function IconPulse() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M2 9.5h3l1.6-4.2 2.6 8 1.8-5.4 1.2 1.6H16"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function IconCopy() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M4.3 11.3V4.3a1.3 1.3 0 0 1 1.3-1.3h7"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
...
function IconDoc() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M4.5 2.5h6l3 3v10a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-12a1 1 0 0 1 1-1Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
      <path
        d="M6.5 8.5h5M6.5 11.3h5"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
...
function IconEye() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M1.8 9S4.5 4 9 4s7.2 5 7.2 5-2.7 5-7.2 5-7.2-5-7.2-5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
function IconLayers() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M9 2.5 2 6.3 9 10l7-3.7L9 2.5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
      <path
        d="M2 10 9 13.7 16 10M2 13.4 9 17l7-3.6"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
function IconSettings() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      <path
        d="M9 2.8v1.5M9 13.7v1.5M15.2 9h-1.5M4.3 9H2.8M13.2 4.8l-1 1M5.8 12.2l-1 1M13.2 13.2l-1-1M5.8 5.8l-1-1"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
...
function IconBell() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M5 7.5a4 4 0 0 1 8 0v3.2l1.3 1.9H3.7L5 10.7V7.5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
      <path
        d="M7.5 14.8a1.5 1.5 0 0 0 3 0"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
